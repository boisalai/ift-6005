...
class FoodDatabaseBot:
    ...
    def text_to_sql(self, question: str) -> str:
        ...
        Génère uniquement la requête SQL qui répond à cette question.
        Assure-toi que la requête est compatible avec DuckDB.
        Ne met pas de commentaires ou d'explications, retourne uniquement la requête SQL.
        """
    ...
    def process_user_input(self, user_input: str) -> str:
        ...
        # Génère la réponse
        response = self.generate_response(user_input, validated_sql, result)
